...
public class LoteServiceImpl implements LoteService {
    ...
    public Lote saveLote(LoteDTO loteDTO) throws LoteCadastroInvalido {
        ...
        Date dataValidade;
        try {
            dataValidade = new SimpleDateFormat("yyyy-MM-dd").parse(loteDTO.getDataValidade());
        ...
        if (!dataValidade.before(hoje)) {
            throw new LoteCadastroInvalido("Data de Validade deve ser apos o dia corrente.");
        }
        ...
        Lote novoLote;
        try {
            novoLote = new Lote(dataValidade, loteDTO.getQtdDoses(), loteDTO.getFabricanteVacina(), loteDTO.getIdTipoVacina());
