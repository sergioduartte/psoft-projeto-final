...
public class Cidadao {
    ...
    public Long getIdUltimoAgendamento() {
        return this.idUltimoAgendamento;
    }

    public void setUltimoAgendamento(Long idUltimoAgendamento) {
        this.idUltimoAgendamento = idUltimoAgendamento;
    }
